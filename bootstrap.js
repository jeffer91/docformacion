(() => {
  ...
  async function start() {
    ...
    // Datos variables de las secciones 5, 6 y 7. Se cargan antes del motor vectorial
    // para ampliar formularios, validaciones, cobertura institucional y plantillas Excel.
    ...
    // Resultado final al guardar: Sección 4 → Sección 5 → Sección 6 → Sección 7.
