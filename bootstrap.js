(() => {
  const LOCAL_BUILD = '20260909-1625';
  ...
  async function start() {
    ...
    // Datos variables de las secciones 5 y 6. Se cargan antes del motor vectorial
    // para ampliar formularios, validaciones y plantillas Excel.
    ...
    // Resultado final al guardar: Sección 4 → Sección 5 → Sección 6.
